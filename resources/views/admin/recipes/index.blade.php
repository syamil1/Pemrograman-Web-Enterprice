...
@include('layouts.navbar')
    ...
    <div class="container mt-4">
        ...
        <table class="table table-striped">
            ...
            <tr>
             ...
             <td>
            <form action="{{ route('admin.recipe.delete', $recipe->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus resep ini?')">
                @csrf
                @method('DELETE')
    ...
    @endforeach
        ...
        <a href="{{ route('admin.download.recipes') }}" class="btn btn-success">Download Data Resep (PDF)</a>
    </div>
